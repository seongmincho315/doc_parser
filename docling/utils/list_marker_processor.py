...
(docling_ibm_models/list_item_normalizer/list_marker_processor.py). See
docling/utils/reading_order_rb.py for why this is vendored instead of imported
from the docling-ibm-models package (keeps torch out of doc-parser's base image;
TableFormer et al. live in genon/serving/tableformer/).

To pick up upstream fixes, diff this file against the current
docling_ibm_models/list_item_normalizer/list_marker_processor.py and re-apply
changes by hand.
"""
